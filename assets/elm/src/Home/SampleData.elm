module Home.SampleData exposing (timeSeries, crimeRates, CrimeRate, miserablesGraph, norwegianCarSales, Gender(..), Population, populationMinnesota1850, norwegianCarSalesMiddlePlayers)
